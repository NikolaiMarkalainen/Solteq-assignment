...
namespace Solteq_server.Migrations
{
    ...
    [Migration("20250130121319_Adjusted type for allergens")]
    partial class Adjustedtypeforallergens
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Solteq_server.models.GenericProduct", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("generic_products", (string)null);
                });
            ...
            modelBuilder.Entity("Solteq_server.models.Product", b =>
                {
                    ...
                    b.PrimitiveCollection<string[]>("ProductContains")
                        .IsRequired()
                        .HasColumnType("text[]")
                        .HasColumnName("product_contains");

                    b.PrimitiveCollection<string[]>("ProductDoesNotContain")
                        .IsRequired()
                        .HasColumnType("text[]")
